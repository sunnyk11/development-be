...
class Wishlist extends Model
{
    ...
    public function productdetails()
    {
        ...
        return $this->hasOne('App\Models\product', 'id','product_id')->with('Property_Type','product_sub_locality','product_comparision','UserDetail','product_img','product_state','product_locality','Property_area_unit')->where(['delete_flag'=> '0','draft'=> '0','order_status'=> '0']);
    }
