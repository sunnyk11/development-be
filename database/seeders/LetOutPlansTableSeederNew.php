...
class LetOutPlansTableSeederNew extends Seeder
{
    /**
    ...
    public function run()
    {
        $LetOutPlansData = [
            ...
            ['id' => 1,'plan_name' => 'Maha Raja','plan_ID' => 'LetOut-Plan-MahaRaja-1','payment_type' => 'Advance', 'plan_price' => '20', 'status' => 'enabled', 'created_at' => date('Y-m-d H:m:s'), 'updated_at' => date('Y-m-d H:m:s')],
